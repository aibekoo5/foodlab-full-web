  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="relative h-64 md:h-80 overflow-hidden rounded-b-3xl mx-4 mt-4">
          <img src="/drinks/drinks.png" alt="FoodLab кафе" className="w-full h-full object-cover" />
        </div>
