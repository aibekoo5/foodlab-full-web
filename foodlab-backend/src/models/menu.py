...
class MenuItem(Base):
    ...
    type = Column(Enum(MenuItemType), nullable=False)  # "food" | "drink"
    price = Column(Integer, nullable=False, default=0)  # цена в тенге
    image_url = Column(String, nullable=True)  # фото блюда
