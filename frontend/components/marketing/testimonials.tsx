...
const reviews = [
  { id: 1, name: "Aida", uni: "Narxoz University", text: "Idea is great, I love it. I would use it when it launches!", avatar: "A" },
  { id: 2, name: "Bek", uni: "Narxoz University", text: "This is exactly what we needed. I support it, has great future!", avatar: "B" },
  { id: 3, name: "Diana", uni: "Narxoz University", text: "Awesome idea for students! Saves time and money every day.", avatar: "D" },
]
