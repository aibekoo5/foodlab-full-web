...
const reviews = [
  { id: 1, name: 'Aida', uni: 'Narxoz', text: 'Идея өте керемет, ұнады. Жарыққа шығып жатса қолданар едім!' },
  { id: 2, name: 'Bek', uni: 'Narxoz', text: 'Оо тура осындай керек болып жүр еді. Қолдаймын, болашағы бар.' },
]
