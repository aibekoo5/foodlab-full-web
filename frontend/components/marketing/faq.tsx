...
export function FAQ() {
  ...
  const questions = [
    { q: t.faq1 || 'Қалған кредиттер сақталады ма?', a: t.faq1a || 'Иә, кредиттер сақталады.' },
    { q: t.faq2 || 'Бір күнде бірнеше рет қолдануға болады ма?', a: t.faq2a || 'Күнделікті бір рет.' },
